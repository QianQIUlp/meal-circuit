...
> Agent 读取边界：只有最上方最新日期条目描述当前任务状态；更早条目是历史证据，不能覆盖当前代码、`AGENTS.md`、`README.md` 或 `docs/agent-workbench-v2.md`。
...
- 保留与更新：保留仍被运行时代码使用的 `templates/profile.md`、`templates/settings.json`、协议、迁移、发布、安全和同步文档；重写 `docs/agent-workbench-v2.md` 为当前“今天、计划、我的”产品真源，更新中英文 README、`AGENTS.md` 信息优先级和多端验收文档的时效边界。
