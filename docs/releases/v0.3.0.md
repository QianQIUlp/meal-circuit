...
- Android APK and AAB artifacts are signed with the MealCircuit release key. A formal tagged release cannot be published without the complete Android signing configuration.
