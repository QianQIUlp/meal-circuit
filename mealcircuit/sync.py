...
def _process_pull(connection: sqlite3.Connection, cipher: AccountCipher, payload: dict) -> tuple[dict, list[DomainRevision]]:
...
def sync_now(
    ...
    for _ in range(100):
        ...
        with connect() as connection:
            counts, updates = _process_pull(connection, cipher, pulled)
